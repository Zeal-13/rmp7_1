...
public class MainActivity extends AppCompatActivity {
    ...
    public  void OpenAlertDialog(View view){
        ...
        new AlertDialog.Builder(this)
                ...
                .setMessage("Хотите перейти?")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        String txt = "Вы перешли";
    ...
    public  void OpenDatePickerDialog(View view){
        new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                String txt = String.valueOf(year) + " год, " + String.valueOf(month) + " месяц, " + String.valueOf(dayOfMonth) + " день" ;
                ((TextView)findViewById(R.id.txt)).setText(txt);
            }
        }, 2023, 0, 1).show();
    }
    ...
    public void OpenCustomDialog(View view) {
        ...
        dialogButton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Snackbar.make(view, "Вы выбрали да", Snackbar.LENGTH_SHORT)
        ...
        dialogButton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Snackbar.make(view, "Вы выбрали нет", Snackbar.LENGTH_SHORT)
                        .setAction("Выключить", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                            }
